    ...
    ">
      ...
      <div className="flex justify-between items-center">
        ...
        <div className="flex items-center space-x-[16px]">
          <a
            href="/src/assets/resume_assets/Resume.pdf"
            target="_blank"
          ...
          {/* <a
            href="https://www.linkedin.com/in/anndery-lopes-732864214/"
            target="_blank"
            rel="noopener noreferrer"
            aria-label="Visit Anndery's LinkedIn profile"
          ...
          <a
            href="https://github.com/Annderyphadkar24"
            target="_blank"
            rel="noopener noreferrer"
            aria-label="Visit Anndery's GitHub profile"
            className="focus:outline-none focus:ring-2 focus:ring-purple-500 focus:rounded transition-all"
          >
            <img src={githubIcon} alt="GitHub" className="w-6 h-5" />
          </a>
          <a
            href="mailto:Anndery.phadkar@gmail.com"
            aria-label="Send email to Anndery"
            className="focus:outline-none focus:ring-2 focus:ring-purple-500 focus:rounded transition-all"
          >
